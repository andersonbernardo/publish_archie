var GestorPayment = (function (modulo) {
    "use strict";
    ...
    var Eventos = {
        ...
        ChangePage: function (contexto) {
            ...
            contexto.on('focusout', "#change-page", function () {
                ...
                getPayments($("body.gestorambiente"));
            });
        },
        SearchPayment: function (contexto) {
    ...
    function getPayments(contexto) {
        ...
        var data = {
            ...
            TotalPerPage: 20,
            paginationFunctionJs: "GestorPayment.Pagination"
        };
